...
const PublicationDeclarantCoursDesComptes = ({
    lng,
    intl,
    history,
    userAffect,
 ...
 *  Inialisation
 */
PublicationDeclarantCoursDesComptes.defaultProps = {
    userAffect: null,
 ...
 */
PublicationDeclarantCoursDesComptes.propTypes = {
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(injectIntl(PublicationDeclarantCoursDesComptes))
