 ...
 * @returns
 */
const FormDetailDeclarationCoursDesComptes = ({
    intl,
    step,
    history,
    changeStep,
 ...
 *  Inialisation
 */
FormDetailDeclarationCoursDesComptes.defaultProps = {}
/**
 *  declaration des props
 */
FormDetailDeclarationCoursDesComptes.propTypes = {
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(injectIntl(FormDetailDeclarationCoursDesComptes))
