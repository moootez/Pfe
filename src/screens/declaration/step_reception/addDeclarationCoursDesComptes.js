...
import getDeclarantionCoursDesComptesActions from '../../../redux/declaration/addDeclaration'
 ...
 *
 *
 * @class AddDeclarationCoursDesComptes
 * @extends {React.Component}
 */
class AddDeclarationCoursDesComptes extends React.Component {
    static propTypes = {
        ...
        addDeclarationRequest: PropTypes.func.isRequired,
    ...
    /**
     * Creates an instance of AddDeclarationCoursDesComptes.
     *
     * @param {*} props
     * @memberof AddDeclarationCoursDesComptes
     */
    constructor(props) {
        super(props)
        this.state = {
    ...
    addDeclarationCoursDesComptes = () => {
        const { alertShow, addDeclarationRequest } = this.props
        ...
        if (error)
            ...
            addDeclarationRequest({ ...this.payload, externe: true })
        }
    }
    ...
    render() {
        ...
        return (
            <div className="ctn__declataion">
                <PageTitle label="إضافة تصريح ( إدارة المحاسبات )" />
                {[] && (
                    <FormGroup>
                            ...
                            <div style={{ textAlign: 'center', padding: 20 }}>
                                ...
                                <div>
                                    <ButtonComponent
                                        ...
                                        label="تأكيد"
                                        clicked={
                                            this.addDeclarationCoursDesComptes
                                        }
                                    />
                                    <ButtonComponent
                                        disabled={disable}
...
const mapDispatchToProps = dispatch => ({
    ...
    addDeclarationRequest: payload =>
        dispatch(
            getDeclarantionCoursDesComptesActions.addDeclarationRequest(payload)
        ),
    getAllReferentiels: () =>
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(injectIntl(AddDeclarationCoursDesComptes))
