...
import addLienActions from '../../../redux/pageCms/lien/addLien'
 ...
 */
class addLien extends React.Component {
    static propTypes = {
        lng: PropTypes.string.isRequired,
        response: PropTypes.object,
        intl: PropTypes.object.isRequired,
        history: PropTypes.object.isRequired,
        addLienReq: PropTypes.func.isRequired,
    }
    ...
    /**
     * Creates an instance of addLien.
     *
     * @param {*} props
     * @memberof addLien
     */
     ...
     */
    addLien = () => {
        const { addLienReq } = this.props
        const { payloadState } = this.state
        addLienReq(payloadState)
    }
    ...
    render() {
        ...
        return (
            <div className="ctn__declataion">
                <PageTitle label="إضافة موقع إلكتروني" />
                <FormGroup>
...
const mapStateToProps = state => {
    return {
        response: state.pageCms.addLien.error,
...
const mapDispatchToProps = dispatch => ({
    addLienReq: payload => dispatch(addLienActions.addLienRequest(payload)),
})
