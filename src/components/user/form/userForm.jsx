    ...
    try {
        ...
        listDelegResidence = allReferenciels.referenciels.RefDelegation.filter(
            e =>
                ...
                e.parent.id ===
                    (payload &&
                        payload.gouvernoratResidence &&
                        payload.gouvernoratResidence.id)
        ).map(i => ({
            label:
                lng === 'ar'
                    ? i.intituleAr
        ...
        listCodePostalResidence = allReferenciels.referenciels.RefCodePostale.filter(
            e =>
                ...
                e.parent.id ===
                    (payload &&
                        payload.delegationResidence &&
                        payload.delegationResidence.id)
        ).map(i => ({
            label:
                lng === 'ar'
                    ? i.intituleAr
                ...
                return (
                    ...
                    >
                        <Check
                            ...
                            selectedValue={
                                payload && payload[item.name] === true ? 1 : 0
                            }
                        />
                        {item.sm === 12 && !item.isCheck && <Divider />}
                    </Grid>
