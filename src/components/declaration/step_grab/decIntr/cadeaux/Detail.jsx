...
class Detail extends React.Component {
     ...
     */
    componentDidMount() {
        const { getCadeauxReq, history } = this.props
    ...
    componentWillReceiveProps(nextProps) {
        const { getCadeaux } = nextProps
        if (getCadeaux && getCadeaux.data.length !== 0) {
            this.setState({
                data: getCadeaux.data,
                nothingTodDeclare: getCadeaux.data[0].nothingToDeclare,
            })
        }
    }
