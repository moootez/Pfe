...
class Detail extends React.Component {
     ...
     */
    componentDidMount() {
        const { getValeursReq, history } = this.props
    ...
    componentWillReceiveProps(nextProps) {
        const { getValeurs } = nextProps
        if (getValeurs && getValeurs.data.length !== 0) {
            this.setState({
                data: getValeurs.data,
                nothingTodDeclare: getValeurs.data[0].nothingToDeclare,
            })
        }
    }
