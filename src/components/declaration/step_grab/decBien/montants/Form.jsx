...
const Form = ({
    ...
    let listDivise = []
    let listNatureCompte = []
    try {
        listEtablissement = allReferenciels.referenciels.RefBanque.map(i => ({
            label: i.intituleAr,
            value: i.id,
        }))
        listEtablissement = [...listEtablissement, { label: 'أخر', id: 'أخر' }]
        listNatureCompte = allReferenciels.referenciels.RefNatureCompte.map(
            i => ({
