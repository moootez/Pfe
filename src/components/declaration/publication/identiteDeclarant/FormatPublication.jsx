...
class FormatPublication extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (allFormatsData && allFormatsData.data.length !== 0) {
            const objIdentiteDeclarant = _.omit(
                allFormatsData.data.publications[
                    'Inlucc\\PublicationBundle\\Entity\\RefAppUser'
                ][0],
                ['id']
            )

            Object.assign(this.payload, objIdentiteDeclarant)

            this.setState({
                data: objIdentiteDeclarant,
            })
        }
    }
     ...
     * @memberof FormatPublication
     */
    UpdateIdentiteDeclarant = () => {
        const { updateFormatReq } = this.props
        updateFormatReq({ categorie: 'RefAppUser', obj: this.payload })
    }
    ...
    render() {
        ...
        return (
            <DetailPublication
                ...
                addAction={this.UpdateIdentiteDeclarant}
