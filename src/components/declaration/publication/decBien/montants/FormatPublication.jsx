...
import setListInput from '../../../step_grab/decBien/montants/ListInputs'
...
class FormatPublication extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (
            ...
            const objMontant = _.omit(
                nextProps.allFormatsData.data.publications[
                    'Inlucc\\PublicationBundle\\Entity\\RefMontantSocietefinanciere'
                ][0],
                ['id']
            )

            Object.assign(this.payload, objMontant)
    ...
    updateMontant = () => {
        ...
        updateFormatReq({
            categorie: 'RefMontantSocietefinanciere',
            obj: this.payload,
        })
    }
