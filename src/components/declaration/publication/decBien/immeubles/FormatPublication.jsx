...
import setListInput from '../../../step_grab/decBien/immeubles/ListInputs'
...
class FormatPublication extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (
            ...
            const objImmeuble = _.omit(
                nextProps.allFormatsData.data.publications[
                    'Inlucc\\PublicationBundle\\Entity\\RefImmeuble'
                ][0],
                ['id']
            )

            Object.assign(this.payload, objImmeuble)
    ...
    updateImmeuble = () => {
        ...
        updateFormatReq({ categorie: 'RefImmeuble', obj: this.payload })
    }
