...
import setListInput from '../../../step_grab/decBien/fontCommerces/ListInputs'
...
class FormatPublication extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (
            ...
            const objFondCommerce = _.omit(
                nextProps.allFormatsData.data.publications[
                    'Inlucc\\PublicationBundle\\Entity\\RefFondsCommerce'
                ][0],
                ['id']
            )

            Object.assign(this.payload, objFondCommerce)

            this.setState({
                data: objFondCommerce,
            })
        }
    }
    ...
    updateFondCommerce = () => {
        ...
        updateFormatReq({ categorie: 'RefFondsCommerce', obj: this.payload })
    }
    ...
    render() {
        ...
        return (
            <DetailPublication
                ...
                addAction={this.updateFondCommerce}
