...
import setListInput from '../../../step_grab/decBien/fontsSpeces/ListInputs'
...
class FormatPublication extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (
            ...
            const objFondEspece = _.omit(
                nextProps.allFormatsData.data.publications[
                    'Inlucc\\PublicationBundle\\Entity\\RefFondsEspece'
                ][0],
                ['id']
            )

            Object.assign(this.payload, objFondEspece)
    ...
    updateFondEspece = () => {
        ...
        updateFormatReq({ categorie: 'RefFondsEspece', obj: this.payload })
    }
    ...
    render() {
        ...
        return (
            <DetailPublication
                ...
                addAction={this.updateFondEspece}
