...
import setListInput from '../../../step_grab/decBien/pSocials/ListInputs'
...
class FormatPublication extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (
            ...
            const objPartSocial = _.omit(
                nextProps.allFormatsData.data.publications[
                    'Inlucc\\PublicationBundle\\Entity\\RefPart'
                ][0],
                ['id']
            )

            Object.assign(this.payload, objPartSocial)
    ...
    updatePartSocial = () => {
        ...
        updateFormatReq({ categorie: 'RefPart', obj: this.payload })
    }
    ...
    render() {
        ...
        return (
            <DetailPublication
                ...
                addAction={this.updatePartSocial}
