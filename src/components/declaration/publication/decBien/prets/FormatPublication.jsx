...
import setListInput from '../../../step_grab/decBien/prets/ListInputs'
...
class FormatPublication extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (
            ...
            const objPret = _.omit(
                nextProps.allFormatsData.data.publications[
                    'Inlucc\\PublicationBundle\\Entity\\RefPretAcquis'
                ][0],
                ['id']
            )

            Object.assign(this.payload, objPret)
    ...
    updatePret = () => {
        ...
        updateFormatReq({ categorie: 'RefPretAcquis', obj: this.payload })
    }
