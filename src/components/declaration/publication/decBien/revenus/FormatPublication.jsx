...
import setListInput from '../../../step_grab/decBien/revenus/ListInputs'
...
class FormatPublication extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (
            ...
            const objRevenu = _.omit(
                nextProps.allFormatsData.data.publications[
                    'Inlucc\\PublicationBundle\\Entity\\RefRevenue'
                ][0],
                ['id']
            )

            Object.assign(this.payload, objRevenu)
    ...
    updateRevenu = () => {
        ...
        updateFormatReq({ categorie: 'RefRevenue', obj: this.payload })
    }
