...
import setListInput from '../../../step_grab/decBien/valeurs/ListInputs'
...
class FormatPublication extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (
            ...
            const objValeur = _.omit(
                nextProps.allFormatsData.data.publications[
                    'Inlucc\\PublicationBundle\\Entity\\RefAutreValeurMobiliers'
                ][0],
                ['id']
            )

            Object.assign(this.payload, objValeur)
    ...
    updateValeur = () => {
        ...
        updateFormatReq({
            categorie: 'RefAutreValeurMobiliers',
            obj: this.payload,
        })
    }
