...
import setListInput from '../../../step_grab/decBien/actions/ListInputs'
...
class FormatPublication extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (
            nextProps.allFormatsData &&
            nextProps.allFormatsData.data.length !== 0 &&
            nextProps.allFormatsData !== allFormatsData
        ) {
            const objAction = _.omit(
                nextProps.allFormatsData.data.publications[
                    'Inlucc\\PublicationBundle\\Entity\\RefAction'
                ][0],
                ['id']
            )
            Object.assign(this.payload, objAction)
            this.setState({
                data: objAction,
            })
        }
    ...
    updateAction = () => {
        ...
        updateFormatReq({ categorie: 'RefAction', obj: this.payload })
    }
