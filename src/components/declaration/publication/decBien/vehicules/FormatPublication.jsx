...
import setListInput from '../../../step_grab/decBien/vehicules/ListInputs'
...
class FormatPublication extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (
            ...
            const objVehicule = _.omit(
                nextProps.allFormatsData.data.publications[
                    'Inlucc\\PublicationBundle\\Entity\\RefVehicule'
                ][0],
                ['id']
            )

            Object.assign(this.payload, objVehicule)
    ...
    updateVehicule = () => {
        ...
        updateFormatReq({ categorie: 'RefVehicule', obj: this.payload })
    }
