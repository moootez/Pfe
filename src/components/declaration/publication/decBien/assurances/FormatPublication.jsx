...
import setListInput from '../../../step_grab/decBien/assurances/ListInputs'
...
class FormatPublication extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (
            ...
            const objAssurance = _.omit(
                nextProps.allFormatsData.data.publications[
                    'Inlucc\\PublicationBundle\\Entity\\RefContratAssurance'
                ][0],
                ['id']
            )

            Object.assign(this.payload, objAssurance)
    ...
    updateAssurance = () => {
        ...
        updateFormatReq({ categorie: 'RefContratAssurance', obj: this.payload })
    }
    ...
    render() {
        ...
        return (
            <DetailPublication
                ...
                addAction={this.updateAssurance}
