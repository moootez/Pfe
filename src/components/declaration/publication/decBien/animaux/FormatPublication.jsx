...
import setListInput from '../../../step_grab/decBien/animaux/ListInputs'
...
class FormatPublication extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (
            ...
            const objAnimeaux = _.omit(
                nextProps.allFormatsData.data.publications[
                    'Inlucc\\PublicationBundle\\Entity\\RefAnimaux'
                ][0],
                ['id']
            )
            Object.assign(this.payload, objAnimeaux)
            this.setState({
                data: objAnimeaux,
            })
        }
    ...
    updateAnimeaux = () => {
        ...
        updateFormatReq({ categorie: 'RefAnimaux', obj: this.payload })
    }
