...
import setListInput from '../../../step_grab/decIntr/etudes/ListInputs'
...
class FormatPublication extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (
            ...
            const objEtude = _.omit(
                nextProps.allFormatsData.data.publications[
                    'Inlucc\\PublicationBundle\\Entity\\RefDeclarationEtude'
                ][0],
                ['id']
            )

            Object.assign(this.payload, objEtude)
    ...
    updateEtude = () => {
        ...
        updateFormatReq({ categorie: 'RefDeclarationEtude', obj: this.payload })
    }
