...
import setListInput from '../../../step_grab/decIntr/actConjoint/ListInputs'
...
class FormatPublication extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (
            ...
            const objActConjoint = _.omit(
                nextProps.allFormatsData.data.publications[
                    'Inlucc\\PublicationBundle\\Entity\\RefActiviteProConjoint'
                ][0],
                ['id']
            )

            Object.assign(this.payload, objActConjoint)
    ...
    updateActConjoint = () => {
        ...
        updateFormatReq({
            categorie: 'RefActiviteProConjoint',
            obj: this.payload,
        })
    }
    ...
    render() {
        ...
        return (
            <DetailPublication
                ...
                addAction={this.updateActConjoint}
