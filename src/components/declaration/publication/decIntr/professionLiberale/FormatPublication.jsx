...
import setListInput from '../../../step_grab/decIntr/professionLiberale/ListInputs'
...
class FormatPublication extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (
            ...
            const objProfession = _.omit(
                nextProps.allFormatsData.data.publications[
                    'Inlucc\\PublicationBundle\\Entity\\RefProfession'
                ][0],
                ['id']
            )
            Object.assign(this.payload, objProfession)
            this.setState({
                data: objProfession,
            })
        }
    ...
    updateProfession = () => {
        ...
        updateFormatReq({ categorie: 'RefProfession', obj: this.payload })
    }
    ...
    render() {
        ...
        return (
            <DetailPublication
                ...
                addAction={this.updateProfession}
