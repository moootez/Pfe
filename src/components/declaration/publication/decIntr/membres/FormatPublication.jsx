...
import setListInput from '../../../step_grab/decIntr/membres/ListInputs'
...
class FormatPublication extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (
            ...
            const objMembre = _.omit(
                nextProps.allFormatsData.data.publications[
                    'Inlucc\\PublicationBundle\\Entity\\RefMembre'
                ][0],
                ['id']
            )
            Object.assign(this.payload, objMembre)
            this.setState({
                data: objMembre,
            })
        }
    ...
    updateMembre = () => {
        ...
        updateFormatReq({ categorie: 'RefMembre', obj: this.payload })
    }
