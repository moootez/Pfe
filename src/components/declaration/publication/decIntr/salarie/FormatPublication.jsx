...
import setListInput from '../../../step_grab/decIntr/salarie/ListInputs'
...
class FormatPublication extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (
            ...
            const objSalarie = _.omit(
                nextProps.allFormatsData.data.publications[
                    'Inlucc\\PublicationBundle\\Entity\\RefSalarie'
                ][0],
                ['id', 'publishedAll']
            )
            Object.assign(this.payload, objSalarie)
            this.setState({
                data: objSalarie,
            })
        }
    ...
    updateSalarie = () => {
        ...
        updateFormatReq({ categorie: 'RefSalarie', obj: this.payload })
    }
