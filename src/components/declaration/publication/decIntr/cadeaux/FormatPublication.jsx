...
import setListInput from '../../../step_grab/decIntr/cadeaux/ListInputs'
...
class FormatPublication extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (
            ...
            const objCadeaux = _.omit(
                nextProps.allFormatsData.data.publications[
                    'Inlucc\\PublicationBundle\\Entity\\RefCadeaux'
                ][0],
                ['id']
            )

            Object.assign(this.payload, objCadeaux)
    ...
    updateCadeaux = () => {
        ...
        updateFormatReq({ categorie: 'RefCadeaux', obj: this.payload })
    }
